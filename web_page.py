...
class WebPageLoader(BaseLoader):
    ...
    def _get_clean_content(html, url) -> str:
        ...
        ids_to_exclude = ["sidebar", "main-navigation", "menu-main-menu","printable1"]
        for id_ in ids_to_exclude:
            tags = soup.find_all(id=id_)
            for tag in tags:
                tag.decompose()

        #added content-block clearfix class coz it is lazy loading same content always
        classes_to_exclude = [
            ...
            "left-content clearfix news_1",
            "sidebar-block list-block white-block clearfix"
        ]
